...
export function DashboardSpotlight({
  ...
  return (
    <article className="bento-tile h-full rounded-2xl border border-border p-4 flex flex-col gap-2 min-h-[200px] bg-bg-white relative overflow-hidden">
      <header className="flex items-center justify-between relative z-10">
        <span className="inline-flex items-center gap-1 text-[0.62rem] font-extrabold uppercase tracking-[0.07em] text-text-secondary">
          ...
          <InfoDot
            ...
            text="The total commercial amount attached to collaborations started in the last 30 days. The badge compares the latest seven days with the seven days before them."
          />
        </span>
