...
export default function AuditLogKM() {
  return (
    <>
      <KMHeader
        title="Audit Log"
        subtitle="One reverse-chronological stream of who did what, when — Sheet edits, deletions, user & access changes, and system errors — for accountability and debugging."
      />

      <KMSection tag="Page layout (top → bottom)">
        <KMList>
          <li>
            <strong>1. PageHeader</strong> — ScrollText icon + title + Know More.
          </li>
          <li>
            <strong>2. Source tiles</strong> — clickable filters: All events ·
            Sheet View · Users &amp; Access · System. Each shows the live count;
            the active tile is outlined. Click to scope the stream.
          </li>
          <li>
            <strong>3. Search</strong> — free-text over actor, action, target and
            detail.
          </li>
          <li>
            <strong>4. Event list</strong> — one row per event: a source badge, the
            action (with a coloured tone dot), the target (table · key), the actor,
            an optional detail (the change diff / message), and the IST timestamp.
          </li>
        </KMList>
      </KMSection>
      ...
      <KMSection tag="Sources">
        <KMList>
          <li>
            ...
            comments (raised / resolved), and row deletions / restores from the Sheet
            View grid.
          </li>
          <li>
      ...
      <KMCallout tone="info">
        ...
        pair it with the Error Portal (to act on system errors) and the User Panel
