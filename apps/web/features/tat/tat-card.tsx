    ...
    return (
      ...
      >
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <InfoTooltip
            title={`${from} to ${to}`}
            content={`Calendar days between ${from.toLowerCase()} and ${to.toLowerCase()} for collabs where both dates are available. Average, best, worst, and sample size use the current filters.`}
            className="ml-auto"
          />
        </div>
    ...
    >
      ...
      <div className="flex items-flex-start gap-2.5 mb-4">
        ...
        <div className="min-w-0 pt-0.5">
          ...
          <div
            className="text-[0.78rem] font-bold leading-[1.3]"
            style={{ color: text }}
          >
            ↳ {to}
          </div>
        ...
        <InfoTooltip
          title={`${from} to ${to}`}
          content={`Calendar days between ${from.toLowerCase()} and ${to.toLowerCase()} for collabs where both dates are available. Average is the normal wait, best is the shortest, worst is the longest, and n is the number measured.`}
          className="ml-auto"
        />
      </div>
      ...
      <div className="flex items-flex-end gap-6 mb-4">
        ...
        <div className="flex flex-col gap-1 mb-1">
          <div className="flex items-center gap-1.5">
            <span className="text-[0.62rem] font-bold text-text-tertiary uppercase w-9">
              Best
            </span>
            <span
