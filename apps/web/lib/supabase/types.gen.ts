  ...
  public: {
    Tables: {
      access_role_permissions: {
        Row: { granted: boolean; role_id: string; scope: string };
        Insert: { granted?: boolean; role_id: string; scope: string };
        Update: { granted?: boolean; role_id?: string; scope?: string };
        Relationships: [
          {
      ...
      posts: {
        ...
        Insert: { [key: string]: Json | undefined } & { post_id: string };
      ...
      shopify_orders: {
        ...
        Insert: { [key: string]: Json | undefined } & { order_id: string };
        Update: { [key: string]: Json | undefined };
        Relationships: [];
      };
      system_errors: {
    ...
    Functions: {
      ...
      get_login_stats: { Args: Record<string, never>; Returns: Json };
      get_user_access: { Args: { p_email: string }; Returns: Json };
      submit_campaign: {
