...
export async function GET(
  ...
  const { data: parent, error: parentErr } = await (supabase as any)
    ...
    .select(
      ...
      ads_usage_rights, partnership_id, ad_partnership_valid, partnership_status, partnership_approved_at,
  ...
  if (parent.inf_id) {
    const { data: sibs } = await (supabase as any)
      ...
      .select(
        ...
        ad_partnership_valid, partnership_status, partnership_approved_at, post_link, post_date, payment_status,
